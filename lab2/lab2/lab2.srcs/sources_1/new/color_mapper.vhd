...
is_ch1_line            <= true when is_within_grid and (ch1.en = '1' and ch1.active = '1') else false;
 
is_ch2_line            <= true when is_within_grid and (ch2.en = '1' and ch2.active = '1') else false;
...
--is_trigger_time <= is_within_grid and (to_integer(position.col) = to_integer(trigger.t));
...
--is_trigger_volt <= is_within_grid and (to_integer(position.row) = to_integer(trigger.v)); 
