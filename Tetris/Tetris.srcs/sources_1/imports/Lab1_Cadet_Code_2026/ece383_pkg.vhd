...
package ece383_pkg is
  ...
  type channel_t is record
    ...
    subtype cell_t is std_logic_vector(2 downto 0);
    
    type row_t is array(0 to 9) of cell_t;
    type board_t is array(0 to 19) of row_t;
    
    constant EMPTY : cell_t := "000";
    constant I_CELL : cell_t := "001";
    constant O_CELL : cell_t := "010";
    constant T_CELL : cell_t := "011";
    constant L_CELL : cell_t := "100";
    constant J_CELL : cell_t := "101";
    constant S_CELL : cell_t := "110";
    constant Z_CELL : cell_t := "111";
  ...
  type piece_cell_t is record
     dx : integer range 0 to 3;
     dy : integer range 0 to 3;
  end record;

  type piece_cells_t is array (0 to 3) of piece_cell_t;
